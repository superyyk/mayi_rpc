...
type UserResponse struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// 用户名称
	Userinfo map[string]string `protobuf:"bytes,2,rep,name=userinfo,proto3" json:"userinfo,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *UserResponse) GetUserinfo() map[string]string {
	if x != nil {
		return x.Userinfo
	}
	return nil
...
var file_rpc_user_proto_rawDesc = []byte{
	...
	,
...
var file_rpc_user_proto_goTypes = []interface{}{
	...
	(*Area)(nil),         // 1: user.Area
	(*UserResponse)(nil), // 2: user.UserResponse
	nil,                  // 3: user.UserResponse.UserinfoEntry
}
var file_rpc_user_proto_depIdxs = []int32{
	3, // 0: user.UserResponse.userinfo:type_name -> user.UserResponse.UserinfoEntry
