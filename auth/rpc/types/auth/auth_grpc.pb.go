...
func (c *tokenClient) GetToken(ctx context.Context, in *GetTokenRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/auth.Token/getToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokenClient) VerifyToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
	err := c.cc.Invoke(ctx, "/auth.Token/verifyToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TokenServer interface {
	GetToken(context.Context, *GetTokenRequest) (*GetResponse, error)
...
func (UnimplementedTokenServer) GetToken(context.Context, *GetTokenRequest) (*GetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetToken not implemented")
}
func (UnimplementedTokenServer) VerifyToken(context.Context, *TokenRequest) (*TokenResponse, error) {
...
func _Token_GetToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Token/getToken",
	}
...
func _Token_VerifyToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Token/verifyToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenServer).VerifyToken(ctx, req.(*TokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
