...
type (
	userdataModel interface {
		...
		FindOneByTel(ctx context.Context, tel string) (*Userdata, error)
	...
	Userdata struct {
		...
		Weixinopenid string `db:"weixinopenid"`
...
func (m *defaultUserdataModel) FindOneByTel(ctx context.Context, tel string) (*Userdata, error) {
